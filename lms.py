...
cnx = pymysql.connect(host="localhost",user="root",password="172791025517",database="lib")
cur = cnx.cursor()
...
bg2 = bg.resize((newImgwidth, newImgheight), Image.LANCZOS)
...
hLabel = Label(hFrame1, text="Welcome to \n RVU Library", bg='gray', fg='black', font=('Calibri',15))
